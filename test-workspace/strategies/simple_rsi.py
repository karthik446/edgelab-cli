...
from src.core.types import Bar, SignalType
...
class SimpleRSI(Strategy):
    ...
    def on_bar(self, bar: Bar) -> Optional[SignalType]:
        ...
        Returns:
            SignalType.LONG for buy signal
            SignalType.SHORT for sell signal
            None for no signal
        """
        ...
        # Trading logic
        if rsi < 40:
            return SignalType.LONG  # Oversold - buy
        elif rsi > 60:
            return SignalType.SHORT  # Overbought - sell
        else:
